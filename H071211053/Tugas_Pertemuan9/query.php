<?php
 class MyQuery
 {
   ...
   function show_data()
   {
     ...
     // [1] : Buatkan query untuk menampilkan 5 data pelanggan terbaru berdasarkan waktu orderan
     //
   ...
   function update_name()
   {
     ...
     // [4] : masukkan query untuk mengupdate nama berdasarkan id
     //
